                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-outline mb-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-primary text-white"><i class="bi bi-upc-scan"></i></span>
                                            <input readonly type="text" value="{{ old('stok') }}" name="stok" id="stok" class="form-control @error('stok') is-invalid @enderror" placeholder="Masukkan Stok Barang...." style="background-color: #BFBFBF"/>
                                            @error('stok')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" value="" name="cabang" id="cabang" class="form-control @error('cabang') is-invalid @enderror" style="background-color: #BFBFBF" />
                                    @error('cabang')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
